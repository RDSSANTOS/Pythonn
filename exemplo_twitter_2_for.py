# módulo (lib) padrão do Pyton para autenticação com API's externas
...
#método gera tokem para urls de autenticação do usuario get_request_token()
request_token, request_token_secret = twitter.get_request_token()

#monta url para autorizar a aplicação à acessar os dados do usuário
